...
class game extends Model
{
    ...
    //protected fillable 
    protected $fillable = ['gamename', 'gametype', 'schedule_date','schedule_time', 'level', 'tag','host', 'host_video_snippet','music_file', 'game_image', 'high_perf_message','low_perf_message', 'round_1_questions', 'round_1_host_video_snippet', 'round_2_questions', 'round_2_host_video_snippet', 'round_3_questions', 'round_3_host_video_snippet', 'trophy', 'published','round1_starting_video_snippet', 'round2_starting_video_snippet', 'round3_starting_video_snippet','time_down_video_snippet', 'deleted','game_start_time'];
